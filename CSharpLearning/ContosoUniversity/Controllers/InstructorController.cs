...
namespace ContosoUniversity.Controllers
{
    public class InstructorController : Controller
    {
        ...
        public ActionResult Index(int? id, int? courseID)
        {
            ...
            //The second Include method loads Courses, 
            //and for each Course that is loaded it does eager loading for the Course.Department navigation property.
            .Include(i => i.Courses.Select(s => s.Department))
            .OrderBy(i => i.LastName);

            if (id != null)
            {
                ViewBag.InstructorID = id.Value;
                //Get Cources filtered by Input Instructor
        ...
        public ActionResult Edit(int? id, string[] selectedCourses)
        {
            ...
            //The TryUpdateModel overload used enables you to whitelist the properties you want to include. 
        ...
        private void UpdateInstructorCourses(string[] selectedCourses, Instructor instructorToUpdate)
        {
            ...
            foreach (var course in db.Courses)
            {
                ...
                {
                    //IF list of  Instructor Courses contain given Course
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            //Update property Instructor of Department
        ...
        private void PopulateAssignedCourseData(Instructor instructor)
        {
            ...
            //SelectList  Courses fpor given Instructor
