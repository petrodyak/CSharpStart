    ...
    public class CourseController : Controller
    {
        ...
        public ActionResult EditPost(int? id)
        {
            ...
            if (TryUpdateModel(courseToUpdate, "", new string[] { "Title", "Credits", "DepartmentID" }))
            {
                ...
                {
                    db.SaveChanges();
                    //After save changes,  return to Index page
                    return RedirectToAction("Index");
                }
                catch (RetryLimitExceededException /* dex */)
                {
        ...
        /// <summary>
        /// The PopulateDepartmentsDropDownList method gets a list of 
        /// all departments sorted by name, creates a SelectList collection for a drop-down list, and passes the collection to the view in a ViewBag property.
        /// </summary>
